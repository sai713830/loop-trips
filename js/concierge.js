(function () {
    ...
    return `<article class="ai-card">
      ...
      <div>
        ...
        <div class="btn-row" style="margin-top:14px">
          <a class="btn btn-fill" href="journey.html?id=${p.j.id}">View trip</a>
  ...
  async function ask(text) {
    ...
    $("#ai-stage").scrollTo({ top: 0, behavior: "smooth" });
  }
  ...
  function mount() {
    ...
    $("#ai-stage").addEventListener("click", (e) => {
    ...
    if (about) {
      ...
      if (j) ask(`Tell me about ${j.title} in ${j.country}, and trips like it`);
    } else if (q) {
      ask(q);
    } else {
      $("#ai-input").focus();
